namespace DesignPatterns_RefactoringGuru.Patterns.Creational.Singleton.ThreadSafe
{
    /// <summary>
    /// This Singleton implementation is called "double check lock". 
    /// It is safe in multithreaded environment and provides lazy 
    /// initialization for the Singleton object.
    /// </summary>
